...
dest_entities = '/Users/apple/Desktop/Railway Game/iron-dominion-mobile/game/public/assets/entities/'
dest_tiles = '/Users/apple/Desktop/Railway Game/iron-dominion-mobile/game/public/assets/tiles/'
dest_resources = '/Users/apple/Desktop/Railway Game/iron-dominion-mobile/game/public/assets/resources/'

os.makedirs(dest_entities, exist_ok=True)
...
for path in glob.glob(src_dir + '*.png'):
    ...
    if prefix.startswith('entity_'):
        out_path = os.path.join(dest_entities, out_name)
    elif prefix.startswith('tile_'):
        out_path = os.path.join(dest_tiles, out_name)
    elif prefix.startswith('icon_'):
        out_path = os.path.join(dest_resources, out_name)
    else:
        continue
